...
SELECT 0.85,'00021','2018 会员日 非处方品种85折 自动化导入',1 UNION ALL 
...
--PM_Index
	...
	Dts_BillID,Factory,LimitDays,MaxQty,MaxPCount,VipMaxQty,VipMaxPCount)
	VALUES(
	'2018-02-01 00:00:00.000','CX-180201-00010',10,2,'2018-02-16 13:46:41，门店版2018,手动指定价格品种,限定50个,超过自动删除',2,CONVERT(VARCHAR(10),GETDATE(),23),'0','2018-02-01 00:00:00.000','2030-12-31 00:00:00.000',
